...
Original code at: https://gist.github.com/paulgambill/cacd19da95a1421d3164 *=================================================================================================================================*/
/**
 ...
 *
 *   - Data from parent JSON elements gets inherited to their child elements, so rows representing child elements contain 
 * the values  of the rows representing their parent elements.
...
// Read JSON files stored at Google Drive and return it's content
function ReadGDriveJSON(){
  var docId = getIdFromUrl('https://drive.google.com/file/d/1EZwlba-G2C2au00nKCAkOphZS6XEBzVe/view?usp=sharing'); 
  var file = DriveApp.getFileById(docId);
  var docContent = file.getBlob().getDataAsString();

  var data   = JSON.parse(docContent);
  var json_data = parseJSONObject_(data, '/categories','noTruncate',includeXPath_, defaultTransform_);
